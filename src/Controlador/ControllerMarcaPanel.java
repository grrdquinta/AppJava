 ...
 * @author gerst
 */
public class ControllerMarcaPanel implements MouseListener {
    
    private mdlMarcaPanel modelo;
    private MarcaPanel vista;
    
    public ControllerMarcaPanel(mdlMarcaPanel modelo, MarcaPanel vista)
    {
        this.modelo = modelo;
        this.vista = vista;
